...
<figcaption id="workflow-caption">איור 2. משאלה ממוקדת לחבילת ראיות מתועדת שאפשר לבדוק. מקור שנדחה חוזר ליומן החיפוש ונשאר בתיעוד ההחלטות. נקודת הבקרה האנושית היא החלטה מחקרית, לא בדיקה סופית לקישוט.</figcaption>
</figure>"""
