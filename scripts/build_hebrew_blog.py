...
POSTS = {
    ...
    "from-one-report-to-two-histories": {
        ...
        "description": (
            "שיטת עבודה לאיתור, לאימות ולהשוואה של ראיות מן העיתונות בכמה שפות. "
            "את התהליך אפשר לשחזר, אך הבינה המלאכותית אינה מחליפה בו את שיקול דעתו של ההיסטוריון."
        ),
        "date": "2026-08-13",
        ...
        "toc": (
            ...
            ("מן הפיילוט ליחידת עבודה לשימוש חוזר", "מן-הפיילוט-לסקיל"),
...
<li><strong>איתור מקורות אפשריים לבדיקה</strong><span>תעדו כל שאילתה, לרבות חיפושים שלא הניבו תוצאות.</span></li>
<li><strong>רשימת מקורות מתועדת</strong><span>שמרו מזהים, מטא־דאטה, קישורים, מצב אימות ומגבלות זכויות.</span></li>
<li><strong>פלט OCR גולמי</strong><span>הפרידו בין פלט המכונה לבין התיקונים המוצעים.</span></li>
<li><strong>אימות חזותי</strong><span>בדקו את הסריקה לפני אישור נוסח או פרט.</span></li>
<li><strong>התאמה בין דיווחים</strong><span>דרשו התאמה בתאריך, במקום ולפחות בשני מאפיינים נוספים.</span></li>
<li><strong>הערכת מקורות</strong><span>בחנו עצמאות, סתירות ומסגור.</span></li>
<li><strong>נקודת בקרה אנושית</strong><span>אשרו, דחו או החזירו את המקור לבדיקה נוספת.</span></li>
<li><strong>חבילת ראיות מתועדת</strong><span>הפיקו מראי מקום, טבלת התאמה וסיכום מסויג.</span></li>
</ol>
</div>
<p class="workflow-return">מקור אפשרי לבדיקה שלא אושר חוזר ליומן החיפוש. הוא נשאר בתיעוד ההחלטות ואינו נעלם מן הרשומה.</p>
<figcaption id="workflow-caption">איור 2. משאלה ממוקדת לחבילת ראיות מתועדת שאפשר לבדוק. מקור שנדחה חוזר ליומן החיפוש ונשאר בתיעוד ההחלטות. נקודת הבקרה האנושית היא החלטה מחקרית, לא בדיקה סופית למראית עין.</figcaption>
</figure>"""
