...
const books = [
  {
        ...
        year: "2009",
        description: "Analyzes the development and operations of Israeli intelligence and counter-terrorism agencies.",
        links: [
  ...
  },
  {
        ...
        publisher: "Columbia University Press",
        year: "2009",
        description: "Explores the emergence and dynamics of Jewish extremist violence within Israel.",
        links: [
  ...
  },
  {
        ...
        year: "2012",
        description: "Documents the rise of the radical right in Israeli politics and its impact on democratic institutions.",
        links: [
          { label: "Publisher", url: "https://global.oup.com/academic/product/the-triumph-of-israels-radical-right-9780199744060" }
              ]
  },
  {
        ...
        year: "2005",
        description: "Provides a comprehensive analysis of suicide terrorism, including its causes, methods, and counter-strategies.",
        links: [
          { label: "Google Scholar", url: "https://scholar.google.com/scholar?q=Suicide+Terrorism+Pedahzur+Polity" }
              ]
  }
  ];
...
const projects = [
  {
        title: "Special Operations Forces and Modern Warfare",
        status: "active",
        description: "Investigating the evolving role of special operations forces in contemporary conflict environments."
  },
  {
        title: "Mapping Violent Non-State Actors",
        status: "active",
        description: "Using big data and network analysis to map the organizational structure of violent non-state actors."
  },
  {
        title: "Political Extremism in Democratic Societies",
        status: "active",
        description: "Studying the rise of political extremism and its effects on democratic governance and institutions."
  }
  ];
...
function renderArticleList(container, items) {
    container.innerHTML = items.map(pub => {
          ...
          const eyebrow = pub.featured ? `<p class="pub-eyebrow" style="font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.08em;color:var(--accent-light);margin-bottom:.25rem;">Featured Work</p>` : "";
          return `
                                                ...
                                                <div class="pub-badges">
                                                          <span class="pub-badge">${pub.type === "journal" ? "Journal Article" : pub.type === "methods" ? "Methods" : pub.type === "chapter" ? "Book Chapter" : pub.type}</span>
                                                                    <span class="pub-badge">${pub.year}</span>
                                                                                    ...
                                                                                    ${pub.summary ? `<p class="pub-meta" style="margin-top:.5rem;">${pub.summary}</p>` : ""}
